                ...
                <div class="settings-section__notifications">
                    ...
                    <div class="settings-section__field is-flex">
                        ...
                        <div class="settings-section__current-param"><span
                                ...
                                class="settings-section__current-param-edit"><svg width="17" height="17"
                                                                                  viewBox="0 0 17 17" fill="none"
                                                                                  xmlns="http://www.w3.org/2000/svg"
                                                                                  class="icon settings-section__current-param-edit-icon"><path
                                ...
                                fill="#2DC574"></path> <path fill-rule="evenodd" clip-rule="evenodd"
